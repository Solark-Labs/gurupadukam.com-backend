  ...
  try {
    ...
    if (!count || count.count === 0) {
      const initialProducts = [
        {
          id: 'p1',
          name: 'Pure Traditional Pasupu',
          name_te: 'పవిత్ర పసుపు',
          price: 149,
          original_price: 199,
          category: 'powder',
        ...
        {
          id: 'p2',
          name: 'Pure Traditional Kumkum',
          name_te: 'పవిత్ర కుంకుమ',
          price: 189,
          original_price: 220,
          category: 'powder',
        ...
        {
          id: 'p3',
          name: 'Premium Pure Sandalwood (Gandham)',
          name_te: 'సుగంధ చందన లేపనం',
          price: 249,
          original_price: 320,
          category: 'powder',
        ...
        {
          id: 'p4',
          name: 'Premium Sacred Vibhuti',
          name_te: 'పవిత్ర భస్మం',
          price: 99,
          original_price: 129,
          category: 'powder',
        ...
        {
          id: 'p7',
          name: 'Hand-Rolled Pure Agarbatti',
    ...
    if (!purohitCount || purohitCount.count === 0) {
      const initialPurohits = [
        ...
        },
        {
          id: 'purohit-5',
          name: 'Kamalakar',
          specialization: 'Satyanarayana Vratam, Namakaranam, Annaprashana',
          rating: 4.9,
          fee: 2800,
        ...
        },
        {
          id: 'purohit-6',
          name: 'Ramakrishna',
          specialization: 'Chandi Homam, Maha Mritunjaya Homam, Ayush Homam',
          rating: 5.0,
          fee: 4500,
          image: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?auto=format&fit=crop&q=80&w=300',
          location: 'Bengaluru',
          bookings_count: 42
        },
        {
          id: 'purohit-7',
          name: 'RadhaManohar',
          specialization: 'Srinivasa Kalyanam, Kedaragowri Vratam, Vastu Shanti',
          rating: 4.8,
          fee: 3200,
          image: '/images/vedic_acharya.png',
          location: 'Chennai',
        ...
        },
        {
          id: 'purohit-8',
          name: 'Shiva kumar',
          specialization: 'Rudrabhishekam, Pradosha Puja, Lingarchana',
          rating: 4.9,
          fee: 2100,
          image: 'https://images.unsplash.com/photo-1609137144814-6d9b43343469?auto=format&fit=crop&q=80&w=300',
          location: 'Hyderabad',
